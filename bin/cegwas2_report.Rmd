...
# show plot in html output
plotly::subplot(plotly_plot_list, shareY = FALSE, titleX = TRUE, titleY = TRUE, nrows = n, margin=0.05, widths=c(0.3, 0.7)) 
```
...
```{r, echo=FALSE, fig.height=5, fig.width=10, out.height=500, out.width=1000}
# read in data table 
